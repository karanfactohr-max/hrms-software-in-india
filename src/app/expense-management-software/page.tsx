...
import {
  ArrowRight, Receipt, CreditCard, FileText, CheckCircle2,
  ChevronDown, Zap, Network, Star, ShieldCheck, Users,
  BarChart3, Calendar, Smartphone, Building2, Calculator, Bell,
  XCircle, Workflow, AlertTriangle, Eye, TrendingUp, Landmark
} from 'lucide-react';

export const metadata: Metadata = {
  title: "Best Expense Management Software in India | Receipt Scanning & GST Compliance",
  description: "Automate expense management India-wide. AI receipt scanning, policy enforcement, multi-level approvals, corporate card integration & GST compliance. Book a free demo.",
  keywords: "expense management India, receipt scanning, travel expense, reimbursement policy, GST compliance, corporate card, advance settlement, expense approval workflow, per diem, mileage reimbursement",
  openGraph: {
    title: "Best Expense Management Software in India | Zero Manual Work",
    description: "Automate receipt scanning, expense approvals, policy enforcement, and GST compliance in one platform.",
    url: 'https://hrmssoftwareinindia.com/expense-management-software',
  ...
  return (
    <main style={{ backgroundColor: 'var(--background)', color: 'var(--foreground)' }} className="min-h-screen font-sans overflow-hidden">
      ...
      <section className="hero-gradient" style={{ paddingTop: "80px", paddingBottom: "0" }}>
        <div className="relative max-w-[1280px] mx-auto px-6 text-center" style={{ zIndex: 1 }}>
          <div className="inline-flex items-center gap-3 p-1 pr-5 rounded-full mb-8 shadow-sm hover:shadow-md hover:-translate-y-0.5 transition-all" style={{ backgroundColor: '#F0FDF4', border: '1px solid #BBF7D0' }}>
            ...
            <span className="text-[13px] font-semibold tracking-wide" style={{ color: '#0F172A' }}>AI-Powered Expense Engine</span>
          </div>

          <h1 style={{ fontSize: "clamp(38px, 5.5vw, 64px)", fontWeight: 800, color: "#141413", lineHeight: 1.1, letterSpacing: "-2.5px", marginBottom: "20px", maxWidth: "860px", marginLeft: "auto", marginRight: "auto" }}>
            {"Expense Management That "}<span style={{ color: "#0E3B32" }}>Actually Works.</span>
          </h1>

          <p style={{ fontSize: "clamp(16px, 1.8vw, 18px)", color: "#6A7282", lineHeight: 1.7, maxWidth: "600px", marginLeft: "auto", marginRight: "auto", marginBottom: "32px" }}>
            Capture receipts, enforce policies, route approvals, and settle advances — all in one platform built for Indian businesses. Zero manual reconciliation.
          </p>
          ...
          <p style={{ fontSize: "13px", color: "#94A3B8", fontWeight: 500, marginBottom: "56px" }}>{"✓ Free setup · GST-ready · 10-min onboarding"}</p>
        </div>
            ...
            <div style={{ background: "#fff", borderRadius: "20px", border: "1px solid #E8E8EF", overflow: "hidden", boxShadow: "0 32px 80px rgba(26,26,46,0.08), 0 1px 3px rgba(26,26,46,0.04)" }}>
              <div className="flex items-center justify-between" style={{ padding: "12px 20px", borderBottom: "1px solid #E8E8EF", background: "#FAFAFC" }}>
                <div className="flex items-center gap-3">
                  ...
                  <div style={{ background: "#fff", borderRadius: "8px", padding: "5px 14px", border: "1px solid #E8E8EF", fontSize: "11px", color: "#8E8EA0", fontFamily: "monospace" }}>app.hrmssuite.in/expenses</div>
                </div>
              ...
              <div className="flex">
                <div className="hidden sm:flex flex-col justify-between" style={{ width: "190px", padding: "16px 12px", borderRight: "1px solid #E8E8EF", background: "#FAFAFC", flexShrink: 0 }}>
                  <div className="space-y-[2px]">
                    {["Dashboard", "My Expenses", "Receipts", "Approvals", "Corporate Cards", "Advances", "Reports", "Policy Engine"].map((label, idx) => (
                  ...
                  <div style={{ padding: "12px", borderRadius: "10px", background: "linear-gradient(135deg, #0E3B32, #1A4D3F)", color: "#fff" }}>
                    ...
                    <p style={{ fontSize: "10px", opacity: 0.8, lineHeight: 1.4 }}>AI receipt scanning included</p>
                  </div>
                </div>
                <div style={{ flex: 1, padding: "20px", minWidth: 0, background: "#fff" }}>
                  <div className="flex items-center justify-between" style={{ marginBottom: "20px" }}>
                    <div>
                      <p style={{ fontSize: "16px", fontWeight: 700, color: "#1A1A2E" }}>Expenses — March 2026</p>
                      <p style={{ fontSize: "12px", color: "#8E8EA0" }}>{"47 pending · ₹3.2L approved this week"}</p>
                    </div>
                  ...
                  <div className="grid grid-cols-2 lg:grid-cols-4 gap-3" style={{ marginBottom: "20px" }}>
                    {[
                      { label: "Total Claims", value: "₹8.4L", change: "12% vs last mo", color: "#0E3B32", bg: "#EAF8F0" },
                      { label: "Pending Approval", value: "₹2.1L", change: "14 requests", color: "#D97706", bg: "#FEF3C7" },
                      { label: "Receipts Scanned", value: "342", change: "98% auto-captured", color: "#059669", bg: "#D1FAE5" },
                      { label: "Policy Violations", value: "3", change: "Flagged & resolved", color: "#DC2626", bg: "#FEE2E2" },
                    ].map((stat) => (
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-5 gap-3">
                    <div className="md:col-span-3" style={{ background: "#fff", borderRadius: "12px", padding: "18px", border: "1px solid #E8E8EF" }}>
                      <div className="flex items-center justify-between" style={{ marginBottom: "14px" }}>
                        <div className="flex items-center gap-2">
                          ...
                          <p style={{ fontSize: "13px", fontWeight: 700, color: "#1A1A2E" }}>Recent Expense Claims</p>
                        </div>
                        <span style={{ fontSize: "11px", color: "#0E3B32", fontWeight: 600 }}>View All</span>
                      </div>
                      <div className="space-y-[6px]">
                        {[
                          { emp: "Rahul S.", cat: "Travel — Flight", amt: "₹12,450", status: "Approved", sC: "#059669", sB: "#D1FAE5" },
                          { emp: "Priya M.", cat: "Client Dinner", amt: "₹4,200", status: "In Review", sC: "#D97706", sB: "#FEF3C7" },
                          { emp: "Amit K.", cat: "Hotel — Mumbai", amt: "₹8,900", status: "Approved", sC: "#059669", sB: "#D1FAE5" },
                          { emp: "Sneha R.", cat: "Taxi — Local", amt: "₹850", status: "Policy Flag", sC: "#DC2626", sB: "#FEE2E2" },
                          { emp: "Vikram P.", cat: "Mileage — 240km", amt: "₹3,600", status: "Approved", sC: "#059669", sB: "#D1FAE5" },
                        ].map((item) => (
                          <div key={item.emp} className="flex items-center gap-3" style={{ padding: "10px 12px", borderRadius: "8px", background: "#FAFAFC", border: "1px solid #F0F0F5" }}>
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between" style={{ marginBottom: "2px" }}>
                                ...
                                <span style={{ fontSize: "12px", color: "#1A1A2E", fontWeight: 700 }}>{item.amt}</span>
                              </div>
                              <div className="flex items-center justify-between">
                                <p style={{ fontSize: "11px", color: "#8E8EA0" }}>{item.cat}</p>
                    ...
                    <div className="md:col-span-2 space-y-3">
                      <div style={{ background: "#fff", borderRadius: "12px", padding: "18px", border: "1px solid #E8E8EF" }}>
                        <p style={{ fontSize: "13px", fontWeight: 700, color: "#1A1A2E", marginBottom: "12px" }}>Spend by Category</p>
                        <div className="space-y-[8px]">
                          {[
                            { label: "Travel & Flights", value: "₹3.2L", pct: 38, color: "#0E3B32" },
                            { label: "Hotels & Lodging", value: "₹2.1L", pct: 25, color: "#60D184" },
                            { label: "Meals", value: "₹1.4L", pct: 17, color: "#CFF25E" },
                            { label: "Local Transport", value: "₹0.9L", pct: 11, color: "#0EA5E9" },
                          ].map((item) => (
                            <div key={item.label}>
                      ...
                      <div style={{ background: "#fff", borderRadius: "12px", padding: "18px", border: "1px solid #E8E8EF" }}>
                        ...
                        <div className="space-y-[8px]">
                          {[
                            { action: "Receipt auto-scanned", time: "1 min ago", initials: "RS", bg: "#D1FAE5", color: "#059669" },
                            { action: "Advance settled — ₹15K", time: "12 min ago", initials: "AS", bg: "#E0F2FE", color: "#0EA5E9" },
                            { action: "Policy violation flagged", time: "28 min ago", initials: "PV", bg: "#FEF3C7", color: "#D97706" },
                          ].map((item) => (
      ...
      <section className="py-24" style={{ background: '#FFFFFF' }}>
        <div className="max-w-[1280px] mx-auto px-6">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4" style={{ marginBottom: '40px' }}>
            {[
              { stat: '15+ hrs', label: 'Wasted monthly', sub: 'on manual reconciliation', color: '#DC2626' },
              { stat: '22%', label: 'Over-budget spend', sub: 'due to no real-time policy checks', color: '#D97706' },
              { stat: '3 weeks', label: 'Avg reimbursement time', sub: 'with email-based approvals', color: '#9333EA' },
              { stat: '₹2.4L', label: 'Lost GST credit/year', sub: 'from missing/invalid receipts', color: '#0EA5E9' },
            ].map((item) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            {[
              { title: 'Receipt Chaos', items: ['Employees lose paper receipts weekly', 'Blurry photos rejected by finance', 'Days spent chasing documentation'], icon: <Receipt className="w-5 h-5" />, accent: '#DC2626', accentBg: '#FEF2F2' },
              { title: 'Policy Violations', items: ['No real-time limit enforcement', 'Over-spending discovered weeks later', 'Audit nightmares from non-compliance'], icon: <ShieldCheck className="w-5 h-5" />, accent: '#D97706', accentBg: '#FFFBEB' },
              { title: 'Approval Delays', items: ['Claims stuck in email for days', 'Managers unavailable for sign-off', 'Employees wait weeks for reimbursement'], icon: <Calendar className="w-5 h-5" />, accent: '#9333EA', accentBg: '#FAF5FF' },
            ].map((card) => (
      ...
      <section className="py-24" style={{ backgroundColor: '#F8FAFC', backgroundImage: 'repeating-linear-gradient(90deg, rgba(15,23,42,0.06) 0px, rgba(15,23,42,0.06) 1px, transparent 1px, transparent 84px)' }}>
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="text-center" style={{ marginBottom: '48px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(30px, 3.8vw, 44px)', fontWeight: 800, color: '#0F172A', lineHeight: 1.12, letterSpacing: '-0.03em', marginBottom: '14px' }}>
              Everything to control expenses end-to-end
            </h2>
            <p style={{ fontSize: '16px', color: '#64748B', lineHeight: 1.7, maxWidth: '520px', marginLeft: 'auto', marginRight: 'auto' }}>
              AI receipt scanning to multi-level approvals — built for Indian businesses.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
            {[
              { title: "AI Receipt Scanning", desc: "Snap a photo or forward email — AI extracts vendor, amount, date, GSTIN automatically.", icon: <Receipt className="w-5 h-5" />, iconBg: '#EFF6FF', iconColor: '#2563EB' },
              { title: "Policy Engine", desc: "Per diem limits, meal caps, hotel tiers, mileage rates — enforced in real-time.", icon: <ShieldCheck className="w-5 h-5" />, iconBg: '#EAF8F0', iconColor: '#059669' },
              { title: "Multi-Level Approvals", desc: "Route through team leads, dept heads, finance — with SLA-based escalation.", icon: <Users className="w-5 h-5" />, iconBg: '#F0FDFA', iconColor: '#0D9488' },
              { title: "Corporate Card Integration", desc: "Auto-match HDFC, ICICI, Axis, SBI card transactions with employee claims.", icon: <CreditCard className="w-5 h-5" />, iconBg: '#FAF5FF', iconColor: '#9333EA' },
              { title: "Advance Management", desc: "Issue travel advances, track utilization, auto-settle against submitted claims.", icon: <Calculator className="w-5 h-5" />, iconBg: '#FDF2F8', iconColor: '#DB2777' },
              { title: "GST & Analytics", desc: "GST input credit tracking, spend analytics by category, and audit-ready exports.", icon: <BarChart3 className="w-5 h-5" />, iconBg: '#FFF7ED', iconColor: '#EA580C' },
            ].map((item, i) => (
      ...
      <section className="py-24" style={{ background: '#F0FDF4' }}>
        <div className="max-w-[1200px] mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { step: '01', title: 'Capture Receipt', desc: 'Snap photo, forward email, or upload PDF. AI extracts all details in seconds.', icon: <Smartphone className="w-6 h-6" /> },
              { step: '02', title: 'Auto-Validate', desc: 'Expense categorized, policy-checked, and GST validated. Violations flagged instantly.', icon: <ShieldCheck className="w-6 h-6" /> },
              { step: '03', title: 'Route & Approve', desc: 'Claims flow through configured approval chain with push notifications at every step.', icon: <Users className="w-6 h-6" /> },
              { step: '04', title: 'Reimburse', desc: 'Approved expenses paid via payroll or bank transfer. Cards auto-reconciled.', icon: <CreditCard className="w-6 h-6" /> },
            ].map((item, i) => (
      ...
      <section className="py-24 text-white" style={{ background: '#102D23' }}>
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-lg max-w-2xl mx-auto" style={{ color: '#B9C7D6' }}>Accounting, payroll, banking, and travel tools — all connected.</p>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {[
              { name: "Tally", desc: "Accounting" }, { name: "QuickBooks", desc: "Accounting" }, { name: "Payroll", desc: "HRMS" },
              { name: "HDFC Bank", desc: "Banking" }, { name: "ICICI Bank", desc: "Banking" }, { name: "Corp Cards", desc: "Cards" },
            ].map((item, i) => (
              <div key={i} className="rounded-2xl p-5 text-center transition-all duration-300 hover:-translate-y-1" style={{ background: 'linear-gradient(180deg, rgba(15,23,42,0.34) 0%, rgba(15,23,42,0.56) 100%)', border: '1px solid rgba(148,163,184,0.4)' }}>
                <div className="mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-xl" style={{ background: '#FFFFFF', border: '1px solid #D1FAE5' }}>
                  <CreditCard className="w-6 h-6" style={{ color: '#102D23' }} />
                </div>
      ...
      <section className="py-24" style={{ background: 'linear-gradient(180deg, #F0FDF4 0%, #DCFCE7 50%, #F0FDF4 100%)' }}>
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 style={{ fontSize: 'clamp(30px, 3.8vw, 44px)', fontWeight: 800, color: '#0F172A', lineHeight: 1.12, letterSpacing: '-0.03em' }}>De-risk your expense management decision</h2>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
            {[
              { metric: "₹200+ Cr", label: "Expenses Processed", desc: "Managed annually across India" },
              { metric: "1,800+", label: "Indian Businesses", desc: "From startups to large enterprises" },
              { metric: "98%", label: "Receipt Auto-Capture", desc: "AI-powered OCR eliminates manual entry" },
            ].map((item) => (
          ...
          <div className="flex flex-wrap justify-center gap-4 mb-12">
            {[
              { name: "ISO 27001", desc: "Information Security" }, { name: "256-bit Encryption", desc: "Data Protection" },
              { name: "GDPR Compliant", desc: "Data Privacy" }, { name: "GST Ready", desc: "Tax Compliance" },
            ].map((item) => (
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {[
              { quote: "We used to spend 3 days reconciling travel expenses. Now it takes 20 minutes. Receipt scanning alone saved hundreds of hours.", name: "Rajesh Kumar", role: "CFO, IT Services Company" },
              { quote: "The policy engine caught over-limit hotel bookings before submission. Travel spend dropped 22% in the first quarter.", name: "Anita Deshmukh", role: "Finance Head, Manufacturing Firm" },
            ].map((item) => (
      ...
      <section className="py-24" style={{ background: '#E3FE7A' }}>
        <div className="max-w-[1200px] mx-auto px-6">
          <div className="text-center" style={{ marginBottom: '48px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(30px, 3.8vw, 44px)', fontWeight: 800, color: '#0F172A', lineHeight: 1.12, letterSpacing: '-0.03em', marginBottom: '14px' }}>Automated expenses vs the old way</h2>
            <p style={{ fontSize: '16px', color: '#3D5A1E', lineHeight: 1.7, maxWidth: '480px', marginLeft: 'auto', marginRight: 'auto' }}>See why finance teams are switching from manual tracking.</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
            <div style={{ padding: '32px 28px', borderRadius: '24px', background: '#FFFFFF', boxShadow: '0 20px 50px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)' }}>
              <div style={{ marginBottom: '24px' }}>
                ...
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: '#FEF2F2', border: '1px solid #FECACA', borderRadius: 8, padding: '6px 12px', marginTop: '4px' }}>
                  ...
                  <span style={{ fontSize: '12px', color: '#DC2626', fontWeight: 700 }}>15–20% expenses go unbilled monthly</span>
                </div>
              </div>
              <div style={{ width: '100%', height: '1px', background: '#F1F5F9', marginBottom: '20px' }} />
              <div className="space-y-4">
                {['AI Receipt Scanning', 'Real-Time Policy Checks', 'Multi-Level Approvals', 'Corp Card Reconciliation', 'GST Credit Tracking', 'Advance Management', 'Mileage Auto-Calc', 'Budget Alerts'].map((f) => (
            ...
            <div style={{ padding: '32px 28px', borderRadius: '24px', background: '#0E3B32', border: '2px solid #3CB371', position: 'relative', boxShadow: '0 32px 70px rgba(14,59,50,0.35), 0 12px 24px rgba(0,0,0,0.1)', transform: 'scale(1.05) translateY(-8px)' }}>
              ...
              <div style={{ marginBottom: '24px', marginTop: '8px' }}>
                ...
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: 'rgba(207,242,94,0.2)', border: '1px solid rgba(207,242,94,0.4)', borderRadius: 8, padding: '6px 12px', marginTop: '4px' }}>
                  ...
                  <span style={{ fontSize: '12px', color: '#CFF25E', fontWeight: 700 }}>Live in 1–2 days · Free 14-day trial</span>
                </div>
              </div>
            ...
            <div style={{ padding: '32px 28px', borderRadius: '24px', background: '#FFFFFF', boxShadow: '0 20px 50px rgba(0,0,0,0.08), 0 1px 3px rgba(0,0,0,0.04)' }}>
              <div style={{ marginBottom: '24px' }}>
                ...
                <div style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: '#FFF7ED', border: '1px solid #FED7AA', borderRadius: 8, padding: '6px 12px', marginTop: '4px' }}>
                  ...
                  <span style={{ fontSize: '12px', color: '#EA580C', fontWeight: 700 }}>No GST support · Complex Indian laws</span>
                </div>
              </div>
              <div style={{ width: '100%', height: '1px', background: '#F1F5F9', marginBottom: '20px' }} />
              <div className="space-y-4">
                {[
                  { text: 'AI Receipt Scanning', s: null }, { text: 'Real-Time Policy Checks', s: 'Partial' }, { text: 'Multi-Level Approvals', s: 'Basic' },
                  { text: 'Corp Card Reconciliation', s: null }, { text: 'GST Credit Tracking', s: null }, { text: 'Advance Management', s: 'Limited' },
                  { text: 'Mileage Auto-Calc', s: null }, { text: 'Budget Alerts', s: 'Add-on' },
                ].map((f) => (
      ...
      <section style={{ padding: "88px 0", background: "#102D23", color: "#fff", position: "relative", overflow: "hidden" }}>
        ...
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              <span style={{ display: "inline-block", padding: "6px 14px", borderRadius: "999px", background: "rgba(96,209,132,0.15)", border: "1px solid rgba(134,239,172,0.22)", color: "#86EFAC", fontSize: "12px", fontWeight: 700, marginBottom: "16px" }}>Employee Expense App</span>
              <h2 style={{ fontSize: "clamp(30px, 3.9vw, 46px)", fontWeight: 800, lineHeight: 1.12, marginBottom: "18px", color: "#F8FAFC", letterSpacing: "-0.03em", maxWidth: "620px" }}>
                ...
                <span style={{ display: "block", color: "#CFF25E", marginTop: "8px" }}>Snap. Submit. Get reimbursed.</span>
              </h2>
              <p style={{ fontSize: "16px", color: "rgba(255,255,255,0.7)", lineHeight: 1.8, marginBottom: "26px", maxWidth: "620px" }}>
                Employees capture receipts, submit claims, track approval status, and view reimbursement history — all from their phone.
              </p>
              <div className="flex flex-wrap gap-3" style={{ marginBottom: "24px" }}>
                {["Receipt capture", "Policy checks", "Approval tracking", "Advance requests"].map((item) => (
                ...
                <div style={{ width: "300px", background: "#102D23", borderRadius: "36px", padding: "10px", boxShadow: "0 36px 90px rgba(16,45,35,0.45)" }}>
                  <div style={{ background: "#F8FAFC", borderRadius: "26px", overflow: "hidden", minHeight: "420px" }}>
                    ...
                    <div style={{ padding: "14px 16px 18px" }}>
                      <div className="flex items-center justify-between" style={{ marginBottom: "14px" }}>
                        <div>
                          <p style={{ fontSize: "10px", color: "#64748B", textTransform: "uppercase", letterSpacing: "0.12em", fontWeight: 700 }}>Expense Wallet</p>
                      ...
                      <div style={{ padding: "16px", borderRadius: "22px", background: "linear-gradient(135deg, #102D23 0%, #1A3F32 100%)", border: "1px solid rgba(96,209,132,0.3)", marginBottom: "14px" }}>
                        <p style={{ fontSize: "10px", color: "#BFEA4D", marginBottom: "4px", fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase" }}>Total claimed</p>
                        <p style={{ fontSize: "34px", fontWeight: 800, color: "#F8FAFC", lineHeight: 1 }}>₹24,350</p>
                        <div className="flex items-center justify-between" style={{ marginTop: "10px" }}>
                          <p style={{ fontSize: "11px", color: "#60D184", fontWeight: 700 }}>7 receipts this month</p>
                          <span style={{ fontSize: "10px", padding: "4px 10px", borderRadius: "999px", background: "rgba(96,209,132,0.15)", color: "#60D184", fontWeight: 700, border: "1px solid rgba(96,209,132,0.25)" }}>On Track</span>
                        </div>
                      </div>
                      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "10px", marginBottom: "14px" }}>
                        <div style={{ padding: "12px", borderRadius: "16px", background: "#FFFFFF", border: "1px solid #DDE7DE" }}>
                          <p style={{ fontSize: "10px", color: "#94A3B8", textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 700 }}>Approved</p>
                          <p style={{ fontSize: "18px", color: "#102D23", fontWeight: 800, marginTop: "4px" }}>₹18,200</p>
                          <p style={{ fontSize: "10px", color: "#60D184", marginTop: "2px", fontWeight: 700 }}>5 claims</p>
                        </div>
                        <div style={{ padding: "12px", borderRadius: "16px", background: "#FFFFFF", border: "1px solid #DDE7DE" }}>
                          <p style={{ fontSize: "10px", color: "#94A3B8", textTransform: "uppercase", letterSpacing: "0.08em", fontWeight: 700 }}>Pending</p>
                          <p style={{ fontSize: "18px", color: "#D97706", fontWeight: 800, marginTop: "4px" }}>₹6,150</p>
                          <p style={{ fontSize: "10px", color: "#64748B", marginTop: "2px" }}>2 in review</p>
                        </div>
                      </div>
                      <div style={{ padding: "14px", borderRadius: "18px", border: "1px solid #DDE7DE", background: "#FFFFFF" }}>
                        <p style={{ fontSize: "12px", fontWeight: 800, color: "#102D23", marginBottom: "10px" }}>Recent Submissions</p>
                        <div className="space-y-3">
                          {[
                            { label: "Flight — BLR to DEL", val: "₹8,450", color: "#059669" },
                            { label: "Hotel — Mumbai 2N", val: "₹6,200", color: "#059669" },
                            { label: "Client dinner", val: "₹3,550", color: "#D97706" },
                          ].map((r) => (
        ...
        <div className="max-w-[1240px] mx-auto px-6 relative z-10">
          <div className="text-center max-w-[720px] mx-auto" style={{ marginBottom: '56px' }}>
            ...
            <h2 style={{ fontSize: 'clamp(32px, 4.2vw, 48px)', fontWeight: 800, color: '#0F172A', lineHeight: 1.1, letterSpacing: '-0.03em', marginBottom: '18px' }}>
              What changes when expenses run <span style={{ color: '#3CB371' }}>automatically</span>
            </h2>
            <p style={{ fontSize: '17px', color: '#64748B', lineHeight: 1.75, maxWidth: '560px', marginLeft: 'auto', marginRight: 'auto' }}>Five areas where automation replaces hours of manual work.</p>
          </div>
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-start">
            {/* LEFT: Advantage cards */}
            <div className="flex flex-col gap-4">
              {[
                { num: '01', title: 'Receipt Processing', before: 'Manual data entry from paper receipts', after: 'AI scans and extracts in 3 seconds', icon: <Receipt className="w-5 h-5" /> },
                { num: '02', title: 'Policy Enforcement', before: 'Violations discovered during monthly audit', after: 'Real-time checks before submission', icon: <ShieldCheck className="w-5 h-5" /> },
                { num: '03', title: 'Approval Speed', before: 'Claims stuck in email for 1-3 weeks', after: 'Push notifications, approved in hours', icon: <Zap className="w-5 h-5" /> },
                { num: '04', title: 'GST Compliance', before: 'Missing receipts = lost input credit', after: 'Auto GSTIN capture and credit tracking', icon: <FileText className="w-5 h-5" /> },
                { num: '05', title: 'Reconciliation', before: 'Days of matching cards to claims', after: 'Corporate cards auto-reconciled instantly', icon: <CreditCard className="w-5 h-5" /> },
              ].map((row) => (
            ...
            <div className="flex justify-center lg:sticky lg:top-32">
              <div style={{ width: '100%', maxWidth: '480px' }}>
                <div style={{ background: '#FFFFFF', borderRadius: '20px', overflow: 'hidden', boxShadow: '0 40px 80px rgba(0,0,0,0.08), 0 0 0 1px rgba(0,0,0,0.04)' }}>
                  <div className="flex items-center justify-between" style={{ padding: '14px 20px', background: '#0E3B32', borderBottom: '1px solid rgba(255,255,255,0.08)' }}>
                    <div className="flex items-center gap-2">
                      ...
                      <span style={{ fontSize: '11px', color: 'rgba(255,255,255,0.5)', fontFamily: 'monospace', marginLeft: '8px' }}>expense-engine</span>
                    </div>
                    <div className="flex items-center gap-2">
                  ...
                  <div style={{ padding: '24px' }}>
                    <div className="flex items-center justify-between" style={{ marginBottom: '20px' }}>
                      <div>
                        <p style={{ fontSize: '11px', color: '#94A3B8', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.1em' }}>March 2026 Expenses</p>
                        <p style={{ fontSize: '22px', fontWeight: 800, color: '#0F172A', marginTop: '2px' }}>₹8.4 Lakhs</p>
                      </div>
                    ...
                    <div className="grid grid-cols-3 gap-3" style={{ marginBottom: '20px' }}>
                      {[
                        { label: 'Receipts', value: '342', color: '#059669' },
                        { label: 'Auto-Captured', value: '98%', color: '#0EA5E9' },
                        { label: 'Violations', value: '3', color: '#DC2626' },
                      ].map((kpi) => (
                    ...
                    <div style={{ padding: '16px', borderRadius: '14px', background: '#F0FDF4', border: '1px solid #BBF7D0' }}>
                      ...
                      <div className="space-y-2">
                        {['AI Receipt Scanning — Active', 'Policy Engine — Enforcing', 'GST Validation — Auto', 'Card Reconciliation — Synced', 'Approval Routing — Live'].map((task) => (
                ...
                <div style={{ display: 'flex', justifyContent: 'center', gap: '12px', marginTop: '16px' }}>
                  <div style={{ padding: '8px 16px', borderRadius: '999px', background: '#F0FDF4', border: '1px solid #BBF7D0', color: '#166534', fontSize: '12px', fontWeight: 600 }}>98% auto-capture</div>
                  <div style={{ padding: '8px 16px', borderRadius: '999px', background: '#EAF8F0', border: '1px solid #BBF7D0', color: '#0E3B32', fontSize: '12px', fontWeight: 600 }}>Zero manual entry</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section style={{ padding: "88px 0", background: "#102D23", position: "relative", overflow: "hidden" }}>
        ...
        <div className="max-w-[900px] mx-auto px-6 text-center relative" style={{ zIndex: 1 }}>
          ...
          <div className="flex flex-wrap justify-center gap-x-8 gap-y-2" style={{ marginTop: "24px" }}>
            {["No credit card required", "Setup in 1-3 days", "Free expense audit"].map((t) => (
      ...
      <section style={{ padding: "100px 0" }}>
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="text-center" style={{ marginBottom: "14px" }}>
            ...
            <h2 style={{ fontSize: "clamp(28px, 3.5vw, 36px)", fontWeight: 700, color: "#1E293B", lineHeight: 1.2 }}>Everything About Expense Management</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-3">
            {[
              { q: "How does AI receipt scanning work?", a: "Snap a photo or forward an email — AI extracts vendor, amount, date, and GSTIN automatically. Supports Hindi and English receipts." },
              { q: "Can I set different policies for different teams?", a: "Yes. Define department-specific per diem rates, hotel tiers, meal caps, and mileage rates. Enforced in real-time at submission." },
              { q: "Is the software GST-compliant?", a: "Fully. Captures GSTIN from receipts, validates numbers, calculates input credit, and generates GST-ready reports for GSTR filing." },
              { q: "How does the approval workflow work?", a: "Configure multi-level chains (employee → lead → finance). Push notifications at every step with SLA-based escalation." },
              { q: "Do you support corporate card integration?", a: "Yes. Auto-match transactions from HDFC, ICICI, Axis, SBI cards with employee claims. Zero manual reconciliation." },
              { q: "How is mileage calculated?", a: "GPS-based tracking on mobile with per-km rates you configure. Auto-calculates reimbursement per Indian tax guidelines." },
              { q: "Can employees request travel advances?", a: "Yes. Submit advance requests, track utilization, and auto-settle against actual expenses after the trip." },
              { q: "How quickly can we go live?", a: "1-3 days. We configure policies, approval workflows, and integrations. Data migration included free." },
            ].map((faq) => (
      ...
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({
        ...
        "@graph": [
          { "@type": "SoftwareApplication", "name": "HRMS Software in India - Expense Management Module", "applicationCategory": "BusinessApplication", "operatingSystem": "Web, iOS, Android", "offers": { "@type": "Offer", "price": "0", "priceCurrency": "INR" }, "aggregateRating": { "@type": "AggregateRating", "ratingValue": "4.8", "ratingCount": "3200" } },
          { "@type": "FAQPage", "mainEntity": [
            { "@type": "Question", "name": "How does AI receipt scanning work?", "acceptedAnswer": { "@type": "Answer", "text": "Snap a photo or forward email. AI extracts vendor, amount, date, and GSTIN automatically." } },
            { "@type": "Question", "name": "Is the software GST-compliant?", "acceptedAnswer": { "@type": "Answer", "text": "Fully. Captures GSTIN, validates numbers, calculates input credit, generates GST-ready reports." } },
            { "@type": "Question", "name": "Do you support corporate card integration?", "acceptedAnswer": { "@type": "Answer", "text": "Yes. Auto-match from HDFC, ICICI, Axis, SBI cards with zero manual reconciliation." } },
            { "@type": "Question", "name": "How quickly can we go live?", "acceptedAnswer": { "@type": "Answer", "text": "1-3 days including policy setup, approval workflows, and free data migration." } }
          ]}
        ]
      })}} />
    </main>
